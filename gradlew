...
# Use the maximum available, or 640w if that is not available.
MAX_FD="maximum"
...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    # - "eval" to run the command
    # - the quoted program name
    # - the quoted arguments
    # Command line length limits:
    # Posix shell: 2048
    # Windows Command Prompt: 8191
    # Windows PowerShell: 8191
    # Modern Unix: 2097152
    eval set -- "$@"
fi
